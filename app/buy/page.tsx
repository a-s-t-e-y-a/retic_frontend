...
export default function ProductThree() {
    return (
        <>
            <Navbar />
            <h1 className='font-bold mx-auto grid w-full max-w-7xl items-center space-y-4 px-2 py-1 md:grid-cols-2 md:gap-6 md:space-y-0 lg:grid-cols-4'>Category 1</h1>
            <div className="mx-auto grid w-full max-w-7xl items-center space-y-4 px-2 py-10 md:grid-cols-2 md:gap-6 md:space-y-0 lg:grid-cols-4">
                ...
                {Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className="rounded-md border">
                        ...
                        />
                        <div className="p-4">
                            <h1 className="inline-flex items-center text-lg font-semibold">Taylor Swift concert</h1>
                            <p className="mt-3 text-sm text-gray-600">
                            Experience the exhilarating Taylor Swift concert in New York, showcasing her chart-topping hits and captivating stage presence.
                            </p>
                            <div className="mt-4">
            ...
            <h1 className='font-bold mx-auto grid w-full max-w-7xl items-center space-y-4 px-2 py-1 md:grid-cols-2 md:gap-6 md:space-y-0 lg:grid-cols-4'>Category 2</h1>
            <div className="mx-auto grid w-full max-w-7xl items-center space-y-4 px-2 py-10 md:grid-cols-2 md:gap-6 md:space-y-0 lg:grid-cols-4">
            ...
            <h1 className='font-bold mx-auto grid w-full max-w-7xl items-center space-y-4 px-2 py-1 md:grid-cols-2 md:gap-6 md:space-y-0 lg:grid-cols-4'>Category 3</h1>
            <div className="mx-auto grid w-full max-w-7xl items-center space-y-4 px-2 py-10 md:grid-cols-2 md:gap-6 md:space-y-0 lg:grid-cols-4">
